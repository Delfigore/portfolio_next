...
const LazyParticleBackground = lazy(() => import('@/components/ParticleBackground').then(mod => ({ default: mod.ParticleBackground })))
        ...
        >
          <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <nav className="flex items-center space-x-1">
              <Button variant="ghost" onClick={() => scrollToSection(aboutRef)} className="text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200">
                About
              </Button>
              <Button variant="ghost" onClick={() => scrollToSection(skillsRef)} className="text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200">
                Skills
              </Button>
              <Button variant="ghost" onClick={() => scrollToSection(projectsRef)} className="text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200">
                Projects
              </Button>
              <Button variant="ghost" onClick={() => scrollToSection(contactRef)} className="text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200">
                Contact
              </Button>
              <Button variant="ghost" onClick={toggleDarkMode} className="text-sm font-medium text-gray-800 dark:text-gray-200 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200">
          ...
          <AnimatedSection>
            <section className="py-12 md:py-24 lg:py-32 xl:py-48 flex items-center justify-center">
              <div className="text-center">
                ...
                >
                  <Button onClick={() => scrollToSection(projectsRef)} className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">View Projects</Button>
                  <Button onClick={() => scrollToSection(contactRef)} variant="outline" className="border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white dark:border-purple-400 dark:text-purple-400 dark:hover:bg-purple-400 dark:hover:text-gray-900 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">Contact Me</Button>
                </motion.div>
              </div>
            </section>
          </AnimatedSection>
